...
class UsersApiTest extends BaseApiTest {
  ...
  void createUserReturnsCreatedResponse() {
    Response response =
        usersApi.createUser(ResourceHelper.readClasspathFile("data/api/create-user.json"));
  ...
  void updateUserReturnsUpdatedDetails() {
    Response response =
        usersApi.updateUser(1, ResourceHelper.readClasspathFile("data/api/update-user.json"));
